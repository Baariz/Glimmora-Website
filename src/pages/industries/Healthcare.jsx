    ...
    <main className="pt-24">
        ...
        <div className="section-container relative z-10">
          ...
          <AnimatedSection>
            <motion.div variants={fadeUp} className="max-w-3xl">
              <span className="inline-block text-xs font-semibold tracking-widest uppercase bg-[#70564b]/10 text-[#70564b] px-4 py-2 mb-6">Industry: Healthcare</span>
        ...
        <div className="section-container">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5">Healthcare Challenges We Address</h2>
            </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="section-container">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5">Healthcare Intelligence Platforms</h2>
            </motion.div>
        ...
        <div className="section-container text-center">
          <AnimatedSection>
            <motion.div variants={fadeUp}>
              <h2 className="text-4xl font-bold text-gray-900 mb-5">Elevate Healthcare Intelligence</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-10">Deploy AI-native compliance and security intelligence across your healthcare network.</p>
