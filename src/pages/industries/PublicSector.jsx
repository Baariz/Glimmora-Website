    ...
    <main className="pt-24">
        ...
        <div className="section-container relative z-10">
          ...
          <AnimatedSection>
            <motion.div variants={fadeUp} className="max-w-3xl">
              <span className="inline-block text-xs font-semibold tracking-widest uppercase bg-[#70564b]/10 text-[#70564b] px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6">Industry: Public Sector & Government</span>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                <Link to="/contact" className="btn-primary px-6 sm:px-8 py-3 sm:py-4 text-center">Request Government Briefing</Link>
                <Link to="/platforms/verifai" className="border-2 border-[#70564b]/40 text-[#70564b] hover:bg-[#70564b]/5 font-semibold px-6 sm:px-8 py-3 sm:py-4 transition-all duration-200 inline-flex items-center justify-center">Explore VerifAI</Link>
              </div>
            </motion.div>
          </AnimatedSection>
        </div>
        ...
        <div className="section-container">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-8 md:mb-14">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-5">Public Sector Challenges We Address</h2>
            </motion.div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="section-container">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-8 md:mb-14">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-5">Sovereign Intelligence Platforms</h2>
            </motion.div>
        ...
        <div className="section-container text-center">
          <AnimatedSection>
            <motion.div variants={fadeUp}>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-5">Deploy Sovereign Intelligence</h2>
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto mb-6 sm:mb-10">Request a government briefing to understand how Glimmora's sovereign AI platforms can transform your public sector organization.</p>
              <Link to="/contact" className="btn-primary px-6 sm:px-8 py-3 sm:py-4 inline-flex items-center gap-2">Request Government Briefing</Link>
            </motion.div>
          </AnimatedSection>
        </div>
      </section>
